...
class Router
{
  ...
  // static :: will make the method static that mean i can access this method without make instence of class 
  // void : return is void that mean we can't make return in this method