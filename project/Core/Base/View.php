...
class View
{
  ...
  public function __construct(string $view, $data = array()) 
  { 
    ...
    include_once dirname(__DIR__, 2) . "/resources/views/partials/$header.php"; // include the header for all the views 
